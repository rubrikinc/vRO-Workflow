// vRO Action rubrikMountSnapshot from package com.rubrik.library.rest.package
//
...
//Construct REST call
var method = "POST";
var url = api_url + "vmware/vm/snapshot/" + snapshotId + "/mount";
var content = '{"hostId":"' + esxiHostId + '","disableNetwork":true}';
